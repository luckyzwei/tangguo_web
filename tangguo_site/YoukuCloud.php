<?php
	...
	if(empty($_REQUEST['vid'])){
		...
		$gid = get_embsig($vid);
		$data=curl_tGet("https://api.youku.com/players/custom.json?type=h5&client_id=908a519d032263f8&video_id=$vid&refer=http://cdn.aixifan.com/player/sslhomura/AcFunV3Player161009.swf&vext=null&embsig=$gid&styleid=undefined&type=mp4");
		...
		$app_m3u8 = 'http://pl.youku.com/partner/m3u8?vid='.$vid.'&type=mp4&ep='.$ep.'&sid='.$sid.'&token='.$token.'&ctype=86&ev=1&oip='.$oip.'';
